...
PLC_FLUCT_SCL_PATH = _get_env("PLC_FLUCT_SCL_PATH", cast=Path)
...
HISTORIAN_MASTER_NAME = _get_env("HISTORIAN_MASTER_NAME", "FLUCT_MASTER_NAME")
HISTORIAN_EXTRA_FUNCTIONS = _get_env(
    "HISTORIAN_EXTRA_FUNCTIONS",
    "FLUCT_EXTRA_FUNCTIONS",
    cast="csv",
)
...
FLUCT_MASTER_NAME = HISTORIAN_MASTER_NAME
FLUCT_EXTRA_FUNCTIONS = HISTORIAN_EXTRA_FUNCTIONS
